...
然后到 [http://adbshell.com/download/download-adb-for-windows.html](http://adbshell.com/download/download-adb-for-windows.html) 下载 adb.zip，解压到`C:\adb`以方便调用。
打开命令行窗口，输入：  
```
cd C:\adb
adb shell
